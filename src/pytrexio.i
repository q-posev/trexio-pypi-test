...
%apply (double* IN_ARRAY1, int64_t DIM1) {(const double* value_sparse_write, int64_t size_value_write)};
%apply (int32_t* IN_ARRAY1, int64_t DIM1) {(const int32_t* index_sparse_write, int64_t size_index_write)};

%apply (int32_t* ARGOUT_ARRAY1, int DIM1) {(int32_t* const index_sparse_read, int64_t size_index_read)};
%apply (double* ARGOUT_ARRAY1, int DIM1) {(double* const value_sparse_read, int64_t size_value_read)};
